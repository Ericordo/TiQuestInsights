//
//  DashboardViewControllerBis.swift
//  TiQuest
//
//  Created by Eric Ordonneau on 25/07/2019.
...
//        detailedView.bottomAnchor.constraint(equalTo: stackView.topAnchor, constant: -10).isActive = true
...
//        todaySalesChart.bottomAnchor.constraint(equalTo: detailedView.bottomAnchor, constant: -60).isActive = true
//        
//        
